...
function new_document({ columns = 80, rows = 100, title = "", author = "", group = "", date = "", palette = [...palette_4bit], font_name = "IBM VGA", ice_colors = true, use_9px_font = true, comments = "", data, font_bytes } = {}) {
